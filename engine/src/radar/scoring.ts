...
export const calculateSignalScore = (
    ...
    // S-GRADE ELITE CONSENSUS: Requires total score 85+, at least 2 whales, AND lead whale must be high-reputation (70+)
    if (totalScore >= 85 && recentWhaleCount > 1 && reputation >= 70) grade = 'S';
