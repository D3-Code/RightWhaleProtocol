                    ...
                    >
                        ...
                        <div className="relative border-l-2 border-zinc-800 ml-3 pl-8 space-y-8">
                            ...
                            <div className="relative">
                                ...
                                <p className="text-zinc-400 text-sm">
                                    Funds are executed according to the strict tokenomic schedule (Burn, LP, RevShare, DevOps), triggering on-chain transactions that are verifiable and logged in the dashboard.
                                </p>
                            </div>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div className="p-4 rounded-lg bg-zinc-900/50 border border-zinc-800 text-center relative overflow-hidden group">
                                ...
                                <p className="text-[10px] text-zinc-600 mt-2">Operational costs & maintenance.</p>
                            </div>
                        </div>
                    </motion.section>
