        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {items.map((item, index) => (
                ...
                >
                    ...
                    <div className={`absolute -right-6 -bottom-6 w-24 h-24 ${item.bg} rounded-full blur-2xl opacity-20`}></div>

                    {/* Interactive Corner Scanline */}
                    <div className="absolute top-0 right-0 w-16 h-16 pointer-events-none opacity-0">
